...
if __name__ == "__main__":
    ...
    trader = ConTrader(r"C:\Users\Mohit\OneDrive\Desktop\ALGO_TRADING\Part4_Materials - Implement and automate\Oanda\oanda.cfg", "EUR_USD", "1min", window = 1, units = 100000)
    trader.get_most_recent()
    trader.stream_data(trader.instrument, stop = 400)
